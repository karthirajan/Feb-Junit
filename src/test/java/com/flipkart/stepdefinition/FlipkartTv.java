...
public class FlipkartTv {
	...
	public void method2() {
		...
		WebElement mobileName = driver.findElement(By.xpath("(//div[contains(text(),'iPhone')])[2]"));
	...
	public void method3() {
		...
		WebElement mobileName2 = driver.findElement(By.xpath("(//span[contains(text(),'iPhone')])[1]"));
